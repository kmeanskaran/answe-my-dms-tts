...
## Delivery Shape
- preferred_language: 
- scale_expectation: 100k DAU
- latency_target: <200ms p99
- budget_constraint: moderate
- deployment_preference: aws, gcp, azure, digitalocean, on_prem, local
...
- Business-friendly cloud option comparison for local, hybrid, and managed deployments
